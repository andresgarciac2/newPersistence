...
@NamedQueries({
	...
	@NamedQuery(name = "OfferStep.findByOfferIdAndPosition", //Devuelve el paso para una oferta segun posición
	query = "select ofst FROM OfferStep ofst where offerId = :offerId and position = :position")
})
